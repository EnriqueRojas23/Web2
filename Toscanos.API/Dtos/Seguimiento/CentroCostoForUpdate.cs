...
namespace CargaClic.API.Dtos.Matenimiento
{
 public class CentroCostoForUpdate {
        ...
        public string costotercero_fecha {get;set;}
        public string otrosgastos_fecha {get;set;}
