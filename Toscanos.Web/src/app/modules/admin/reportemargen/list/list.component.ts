...
export class ListMargenOperativoComponent implements OnInit {
    ...
    incidencias: Incidencia[] = [];
     ...
     public groups: GroupDescriptor[] = [{ field: 'cliente' , aggregates: this.aggregates }   ];
    ...
    ngOnDestroya(): any {
     ...
     public meses: Array<{ text: string; value: number }> = [];
     public anios: Array<{ text: string; value: number }> = [];
    ...
    ngOnInit(): void {
        ...
        this.meses.push ({ text: 'Enero' , value: 1 });
        this.meses.push ({ text: 'Febrero' , value: 2 });
        this.meses.push ({ text: 'Marzo' , value: 3});
        this.meses.push ({ text: 'Abril' , value: 4 });
        this.meses.push ({ text: 'Mayo' , value: 5 });
        this.meses.push ({ text: 'Junio' , value: 6});
        this.meses.push ({ text: 'Julio' , value: 7 });
        this.meses.push ({ text: 'Agosto' , value: 8 });
        this.meses.push ({ text: 'Septiembre' , value: 9 });
        this.meses.push ({ text: 'Octubre' , value: 10 });
        this.meses.push ({ text: 'Noviembre' , value: 11 });
        this.meses.push ({ text: 'Diciembre' , value: 12 });

        this.anios.push ({ text: '2021' , value: 2021 });
        this.anios.push ({ text: '2022' , value: 2022 });
    ...
    verReporte() {
        ...
        const url = 'http://104.36.166.65/reptwh/repmop.aspx?anio=' + String(this.model.anio.value)
         + '&mes=' + String(this.model.mes.value);
    ...
    private loadItems(): void {
        ...
        this.service.getReporteMargen(this.model.anio.value, this.model.mes.value).subscribe((products) => {
