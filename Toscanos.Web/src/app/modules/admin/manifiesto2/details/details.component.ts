...
import { ManifiestoService } from '../../manifiesto/manifiesto.service';
...
export class DetailsManifiestoComponent implements OnInit {
    ...
    {
        // Edit
        if ( this._data.manifiesto.id )
        {

            // Request the data from the server
            this._notesService.getManifiestoById(this._data.manifiesto.id).subscribe();
